...
- Replicates the work that slash commands and skill `description` triggers already do

**What to do instead:** add or refine slash commands. Document intent → command mapping in `CLAUDE.md` or directly in the slash command files.
