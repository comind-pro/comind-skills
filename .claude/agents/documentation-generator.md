...
description: Generates project documentation (architecture, conventions, domain, dependencies, onboarding) from a codebase analysis profile. Use after project-analyzer to produce the docs that downstream generators read as ground truth.
